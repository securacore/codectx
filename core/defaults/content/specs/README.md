...
Format and process for writing specification documents. Specs are meta-documentation. They capture the reasoning and decisions behind _why_ documentation was created the way it was, so it can be understood, recreated, or revised in the future.

## Location

Every documentation directory contains a `spec/` subdirectory with a `README.md` entry point. For complex specs, `README.md` links to child files within the same `spec/` directory.

- Foundation specs: `docs/foundation/[name]/spec/README.md`
...
How the documentation within this directory is organized. List the files that exist and their purpose. This section is a map. It tells a reader (human or AI) where to find what without reading every file.
